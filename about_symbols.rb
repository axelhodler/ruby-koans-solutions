...
class AboutSymbols < Neo::Koan
  ...
  # ANSWER:
  # comparing the equality of two symbols will compare the identity,
  # not the content
  ...
  # Symbols are put into memory once and stay there until the program exits
  # 1. Only create symbols dynamically if you will to repeatedly access the symbol
